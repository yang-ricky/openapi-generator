...
func (s *UserApiService) CreateUser(ctx context.Context, user User) (ImplResponse, error) {
	...
	//ORIGIN-TODO: Uncomment the next line to return response Response(0, {}) or use other options such as http.Ok ...
...
func (s *UserApiService) GetUserByName(ctx context.Context, username string) (ImplResponse, error) {
	...
	//ORIGIN-TODO: Uncomment the next line to return response Response(200, User{}) or use other options such as http.Ok ...
...
func (s *UserApiService) LoginUser(ctx context.Context, username string, password string) (ImplResponse, error) {
	...
	//ORIGIN-TODO: Uncomment the next line to return response Response(200, string{}) or use other options such as http.Ok ...
