...
func (s *PetApiService) AddPet(ctx context.Context, pet Pet) (ImplResponse, error) {
	...
	//ORIGIN-TODO: Uncomment the next line to return response Response(200, Pet{}) or use other options such as http.Ok ...
	//return Response(200, Pet{}), nil

	//ORIGIN-TODO: Uncomment the next line to return response Response(405, {}) or use other options such as http.Ok ...
...
func (s *PetApiService) DeletePet(ctx context.Context, petId int64, apiKey string) (ImplResponse, error) {
	...
	//ORIGIN-TODO: Uncomment the next line to return response Response(400, {}) or use other options such as http.Ok ...
...
func (s *PetApiService) GetPetById(ctx context.Context, petId int64) (ImplResponse, error) {
	...
	//ORIGIN-TODO: Uncomment the next line to return response Response(404, {}) or use other options such as http.Ok ...
...
func (s *PetApiService) UploadFile(ctx context.Context, petId int64, additionalMetadata string, file *os.File) (ImplResponse, error) {
	...
	//ORIGIN-TODO: Uncomment the next line to return response Response(200, ApiResponse{}) or use other options such as http.Ok ...
