...
func (s *StoreApiService) GetInventory(ctx context.Context) (ImplResponse, error) {
	...
	//ORIGIN-TODO: Uncomment the next line to return response Response(200, map[string]int32{}) or use other options such as http.Ok ...
...
func (s *StoreApiService) GetOrderById(ctx context.Context, orderId int64) (ImplResponse, error) {
	...
	//ORIGIN-TODO: Uncomment the next line to return response Response(200, Order{}) or use other options such as http.Ok ...
